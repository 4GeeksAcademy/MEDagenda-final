...
const Otorrinolaringolia = () => {
    ...
    return (
        ...
        <h2 style={{
            ...
            background: "linear-gradient(to right,rgba(3, 65, 18, 0.99) ,rgb(32, 189, 71) )",
            padding: "10px",
                borderRadius: "0px",
            }}>
                    ...
                    {Array.isArray(store.doctor) && store.doctor.filter(item => item.specialty === "Otorrinolaringología").map(item => (
                        <li
                            ...
                            style={{
                                ...
                                background: "linear-gradient(to right,rgb(29, 168, 233),rgba(9, 238, 66, 0.49))",
                                border: "none",
                                borderRadius: "40px",
...
export default Otorrinolaringolia;